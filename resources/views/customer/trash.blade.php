                        ...
                        <tbody>
                            @foreach ($customers as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('customer.restore',$customer->id) }}" style="color: #2c2c2c;" class="ms-1 me-1"><i class="fas fa-redo"></i></a>
                                        <a href="javascript:;" onclick="
                                        if(confirm('Are you want to delete'))  $('.form-{{ $customer->id }}').submit()
